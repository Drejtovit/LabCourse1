...
import { addItem, removeItem, updateItem } from "@/lib/utils/helpers.js";


export default function ResumeAdminClient({ candidates }) {
    ...
    function handleCandidateChange(e) {
        ...
        candidate?.birthDate ? setFormValues({
            ...formValues,
            age: new Date().getFullYear() - new Date(candidate.birthDate).getFullYear(),
            candidateId
        }) : setFormValues({
            ...formValues,
            candidateId
                            ...
                            <div className="col-lg-9 col-md-12 col-xs-12">
                                <div className="add-resume box">
                                    <form className="form-ad" onSubmit={e => {
                                        ...
                                        <div className="mb-3">
                                            <label className="control-label me-3">Select Candidate:</label>
                                            <select
                                            ...
                                            >
                                                ...
                                                {candidates.map((candidate, index) => (
                                                    <option key={index} value={candidate?.candidateId}>
                                                        {candidate?.user?.name}
                                                    </option>
                                                ))}
                                            </select>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input type="text" name='name'
                                                value={selectedCandidate ? selectedCandidate?.user?.name : ""}
                                                readOnly={true} className="form-control" placeholder="Name"
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input type="text" name='email'
                                                value={selectedCandidate ? selectedCandidate?.user?.email : ""}
                                                readOnly={true} className="form-control" placeholder="Your@domain.com"
                                                style={{ backgroundColor: "#e3f2fd" }} />
                                        </div>
                                        <div className="mb-3">
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input type="text" name='location' className="form-control"
                                                ...
                                                readOnly={true}
                                                value={selectedCandidate ? selectedCandidate?.city + ", " + selectedCandidate?.state : ""}
                                                style={{ backgroundColor: "#e3f2fd" }}
                                            />
                                        </div>
                                        <div className="mb-3">
