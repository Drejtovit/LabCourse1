        ...
        <>
            <div className="d-flex min-vh-100 bg-light">
                ...
                <main className="flex-grow-1 p-3 p-md-4" style={{ background: "#f8f9fa" }}>
                    <div className="d-flex justify-content-center align-items-center min-vh-100 mt-5 mt-lg-0" style={{ background: "linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%)" }}>
                                    ...
                                    <div className="card mb-4 shadow-sm">
                                        ...
                                        <div className="card-body">
                                            <form onSubmit={e => {
                                                ...
                                                <DeleteButton id={user.id} classes="btn btn-danger float-end mt-3 mt-lg-0" disabled={isLoading} item="user" link="/dashboard/users">
                                                    DELETE
                                                </DeleteButton>
                                            </form>
                                        </div>
